...
/* First created by JCasGen Tue Sep 03 20:32:57 EDT 2013 */
...
public class Annotation_Type extends org.apache.uima.jcas.tcas.Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("cmu.edu.types.Annotation");
  ...
  public String getCasProcessorId(int addr) {
      ...
      jcas.throwFeatMissing("casProcessorId", "cmu.edu.types.Annotation");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "cmu.edu.types.Annotation");
