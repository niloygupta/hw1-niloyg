...
/* First created by JCasGen Thu Sep 18 17:56:09 EDT 2014 */
...
/** 
 * Updated by JCasGen Thu Sep 18 17:56:09 EDT 2014
 * @generated */
public class GeneMentionTag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("cmu.edu.types.GeneMentionTag");
  ...
  public String getGeneTag(int addr) {
      ...
      jcas.throwFeatMissing("GeneTag", "cmu.edu.types.GeneMentionTag");
  ...
  public int getTagBegin(int addr) {
      ...
      jcas.throwFeatMissing("TagBegin", "cmu.edu.types.GeneMentionTag");
  ...
  public int getTagEnd(int addr) {
      ...
      jcas.throwFeatMissing("TagEnd", "cmu.edu.types.GeneMentionTag");
  ...
  public String getLineID(int addr) {
      ...
      jcas.throwFeatMissing("LineID", "cmu.edu.types.GeneMentionTag");
